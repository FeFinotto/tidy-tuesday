...
bechdel_by_series %>% 
  ...
  # ggsave("Pct of Passing in Bechdel test.png", width = 40, height = 20, units = "cm", dpi = 300, scale = 1)
```
...
ggplot(parts, aes(fill = pass_bechdel, values = n)) +
  ...
  # ggsave("Bechdel Test X-Men.png", width = 40, height = 20, units = "cm", dpi = 300, scale = 1)
```
...
characters_sum %>% 
  ...
  labs(title = "Which character killed the most of non-human creatures?",
       x = "",
       y = "")
  # ggsave("Character killing.png", width = 40, height = 20, units = "cm", dpi = 300, scale = 1)
...
characters_sum %>% 
  ...
  ggsave("Killing by issue no.png", width = 40, height = 20, units = "cm", dpi = 300, scale = 1)
```
